...
print(f"Kosten toegangstickets: {totale_kosten_tickets} cent")
print(f"Kosten VIP-VR-GameSeat: {TOTALE_KOSTEN_VR_SEAT} cent")
print(f"Totaal te betalen bedrag: {te_betalen_bedrag} cent")
print(f"Dit geweldige dagje-uit met {aantal_personen} mensen in de Speelhal met {tijd_in_minuten} VR kost je maar {te_betalen_bedrag} cent")
